...
async def create_category(
    ...
    """
    Endpoint para la creación de una categoría, recibe una petición con los datos necesarios y
    ejecuta validaciones adicionales. Si todo es correcto, crea la categoría en la base de datos
